...
// Mock the fetchAllDevices function
...
describe("Devices Component - CASE-084 Multiple Filters", () => {
  const mockDevices = [
    {
      device_id: "d1",
      id: "DEV001",
  ...
  it("filters devices by owner + status + pairing code + date range", async () => {
    renderWithProvider(<Devices />);

    const statusFilter = screen.getByRole("combobox");
    await userEvent.selectOptions(statusFilter, "paired");
